...
class WanI2V:
    ...
    def generate(self,
        ...
        with (
            ...
            # [Faster-Wan2.2 P10] Opt-in CUDA-event wall breakdown (BASIWAN_PROFILE=1).
            ...
            for _, t in enumerate(tqdm(timesteps)):
                ...
                if _profile: s0 = _ev(); e0_ = _ev(); s0.record()
                model = self._prepare_model_for_timestep(
                    t, boundary, offload_model)
                sample_guide_scale = guide_scale[1] if t.item(
                ) >= boundary else guide_scale[0]
                if _profile: e0_.record()
                ...
                if _profile:
                    ...
                    _phase_ms['swap'] += s0.elapsed_time(e0_)
            ...
            if _profile:
                ...
                n = len(timesteps)
                logging.info("Faster-Wan2.2 i2v wall breakdown (%d steps):", n)
